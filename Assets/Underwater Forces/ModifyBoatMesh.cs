...
public class ModifyBoatMesh 
{
	...
	public ModifyBoatMesh(GameObject boatObj, GameObject underWaterObj, GameObject aboveWaterObj, Rigidbody boatRB) 
	{
		...
		Debug.Log ("Total " + boatTriangles.Length + " triangles.");
...
//			if(allDistancesToWater[j]>0)
//				Debug.LogAssertion ("Distance from water of vertex " + j + " = " + allDistancesToWater [j]);
		}
