...
//
//		Debug.Log (modifyBoatMesh.underWaterTriangleData.Count + " " + modifyBoatMesh.aboveWaterTriangleData.Count);
		...
		//Direct Buoyancy
		//gameObject.GetComponent<Rigidbody> ().AddForceAtPosition(10000f * Vector3.up, transform.position, ForceMode.Force);
	}
